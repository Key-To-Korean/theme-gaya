 ...
 */
function gaya_featured_posts_slider( $stickies ) {
		...
		while ( $featured->have_posts() ) :
			...
			*/
				...
				<div class="entry-content">
					<header class="entry-header">
						...
						<div class="entry-byline-date">
							by <?php gaya_posted_by(); ?> on <?php gaya_posted_on(); ?>
						</div>
					</header><!-- .entry-header -->
			...
			<div class="entry-meta entry-meta-left">
					<?php
					echo '<span class="entry-permalink"><a href="' . esc_url( get_permalink() ) . '" title="' . esc_attr__( 'Read the article ', 'gaya' ) . esc_attr( get_the_title() ) . '" rel="bookmark">Read Article <i class="fa fa-arrow-right"></i></a></span>';
					gaya_reading_time();
					?>
			</div><!-- .entry-meta -->
