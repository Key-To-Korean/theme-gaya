...
class Better_Subscribe extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'A basic (non-functional) Subscribe box.', 'gaya' ),
		);
		parent::__construct( 'better_subscribe', __( 'Better Subscribe', 'gaya' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Subscribe', 'gaya' ) : $instance['title'], $instance, $this->id_base );
		...
		if ( ! empty( $title ) ) {
			...
			echo esc_html( $args['before_title'] . __( 'Better Subscribe', 'gaya' ) . $args['after_title'] );
		}
		?>
