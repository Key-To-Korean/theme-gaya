...
class Ad_Placeholder extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'A basic Ad Placeholder.', 'gaya' ),
		);
		parent::__construct( 'ad_placeholder', __( 'Ad Placeholder', 'gaya' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Ad', 'gaya' ) : $instance['title'], $instance, $this->id_base );
		...
		if ( ! empty( $title ) ) {
			...
			echo wp_kses_post( $args['before_title'] . __( 'Ad', 'gaya' ) . $args['after_title'] );
		}
		?>
