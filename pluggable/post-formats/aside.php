 ...
 */
function gaya_infinity_link_content( $content ) {
 ...
 * @link http://justintadlock.com/archives/2012/09/06/post-formats-aside
 */
function gaya_infinity_link_excerpt( $excerpt ) {
...
add_filter( 'the_content', 'gaya_infinity_link_content', 9 ); // run before wpautop.
add_filter( 'the_excerpt', 'gaya_infinity_link_excerpt', 9 );
