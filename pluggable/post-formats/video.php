 ...
 */
	 ...
	 */
function gaya_video_backdrop( $content ) {
...
add_filter( 'the_content', 'gaya_video_backdrop' );
...
function gaya_get_the_video() {
	...
	if ( 'video' === get_post_format() ) {
		...
		if ( strpos( $content, '</iframe>' ) === false ) {
			$output = esc_attr__( 'No video found in post.', 'gaya' );
		} else {
