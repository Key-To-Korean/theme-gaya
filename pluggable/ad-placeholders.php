 ...
 */
function gaya_get_placeholder_image_url() {
...
function gaya_get_placeholder_image() {
	echo '<img src="' . gaya_get_placeholder_image_url() . '" />';
}
*/
