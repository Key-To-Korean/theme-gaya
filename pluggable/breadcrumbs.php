...
if ( ! function_exists( 'gaya_breadcrumbs' ) ) :
	/**
	...
	function gaya_breadcrumbs() {
		...
		$home_link  = '<a aria-label="' . esc_html__( 'Home', 'gaya' ) . '" title="' . esc_html__( 'Home', 'gaya' ) . '" class="breadcrumb-home" href="' . esc_url( home_url() ) . '"><i class="fa fa-home"></i></a>' . $separator;

		$output .= "<div aria-label='" . esc_html__( 'You are here:', 'gaya' ) . "' id='$breadcrumb_id' class='$breadcrumb_class'>";
		$output .= $home_link;
