...
get_header(); ?>
	...
	if ( have_posts() ) :
		...
		$this_cat_id   = ! empty( $categories ) ? $categories[0]->cat_ID : 0;
		$term_children = $this_cat_id ? get_term_children( $this_cat_id, 'category' ) : array();
			...
			*/
			...
			foreach ( $term_children as $child ) :
				...
				if ( $query->have_posts() ) {
					...
					// no posts found.
					esc_attr_e( 'No posts found.', 'gaya' );
				}
